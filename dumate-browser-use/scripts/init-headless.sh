...
_diag_session_start "init-headless"

cdp_launch_chrome "true" || return 1 2>/dev/null || exit 1
state_set_cdp_mode "$_CDP_ENDPOINT"
_BROWSER_MODE="cdp"
_diag "INIT_OK | mode=cdp | headless=true | cdp=${_CDP_ENDPOINT}"
